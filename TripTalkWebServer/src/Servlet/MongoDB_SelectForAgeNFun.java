...
public class MongoDB_SelectForAgeNFun
{	
	public MongoDB_SelectForAgeNFun()
	{		
	}
	
	public String Select(Integer user_age, String user_fun)
	{
		Data data = new Data(user_age, user_fun);
		return data.GetList();
	}
	...
	public class Data
	{
		...
		public Data(Integer user_age, String user_fun)
		{
			this.MongoDBConnecting(user_age, user_fun);
			this.SetlistModelParsingNDistinct();
			this.SetListModelSort();
		}
		
		private void MongoDBConnecting(Integer user_age, String user_fun)
		{
